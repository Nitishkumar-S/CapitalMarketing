...
INSERT INTO `LOAN` VALUES ("001","50000","BUSINESS","001","11:23:43");
INSERT INTO `LOAN` VALUES ("002","100000","HOUSE","001","10:34:55");
INSERT INTO `LOAN` VALUES ("003","500000","BUSINESS","003","14:43:44");
INSERT INTO `LOAN` VALUES ("004","200000","BUSINESS","003","16:16:16");
...
SELECT `CID` FROM `COMPANY` UNION SELECT `CID` FROM `SHARES_BOUGHT`;
SELECT * FROM `COMPANY` INNER JOIN `SHARES_BOUGHT` ON `COMPANY`.`CID`=`SHARES_BOUGHT`.`CID`;
SELECT * FROM `COMPANY` LEFT JOIN `SHARES_BOUGHT` ON `COMPANY`.`CID`=`SHARES_BOUGHT`.`CID`;
...
-- STORED PROCEDURE 
-- CREATING PROCEDURE
      CREATE PROCEDURE DISPLAYING_USERS()
      SELECT * FROM USER
      GO;
   
   -- EXECUTING PROCEDURE
   
      EXECUTE DISPLAYING_USERS;
